...
export class Backend implements backendInterface {
    ...
    async getFollowersForDay(arg0: string): Promise<DailyList> {
        if (this.processError) {
            try {
                const result = await this.actor.getFollowersForDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFollowersForDay(arg0: string, arg1: DailyList): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFollowersForDay(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
